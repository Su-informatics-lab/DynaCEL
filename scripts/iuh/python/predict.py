            ...
            for time in prediction_moments:
                ...
                for k in range(5):
                    ...
                    for i in np.arange(y_pred.shape[0]):
                        ...
                        gt_label = y_gt[i]
                        label = y_pred[i]
                        pred_probs_list.append([patient_id, stay_id, prediction_window, time, outcome_window, k, pred_0_prob, pred_1_prob, label, gt_label])
...
model_dir = "/N/project/waveform_mortality/xiang/personalized_hemodynamics/results/models/eicu"
