...
dst_dir = "/N/project/waveform_mortality/xiang/personalized_hemodynamics/results/barplots/iuh/chartevents"
os.makedirs(dst_dir, exist_ok=True)

events = read_events(os.path.join(data_dir, "hr_events.csv"))
time_points = []
n_expired_list = []
n_survival_list = []
expired_rates = []
...
while time <= 96:
    ...
    windowed_events = windowed_events.drop_duplicates(["MRN", "FIN"])
    n_expired = (windowed_events["death_status"]==1).sum()
    n_survival = (windowed_events["death_status"]==0).sum()
